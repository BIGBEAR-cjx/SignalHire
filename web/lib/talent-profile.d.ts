...
export type TalentSearchResult = { search_brief: TalentSearchBrief; search_plan: TalentSearchPlan; source_execution: SourceExecution; evidence_graph: TalentEvidenceGraph; talent_map: TalentMapItem[]; candidates: TalentCandidate[] };
