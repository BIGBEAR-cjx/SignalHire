...
export type CandidateEvidenceDossier = { title: string; conclusion: string; risk_summary: string; verdict_summary: string; metrics: Array<{ label: string; value: string }>; source_types: string[]; primary_evidence: string[]; weak_evidence: string[] };
